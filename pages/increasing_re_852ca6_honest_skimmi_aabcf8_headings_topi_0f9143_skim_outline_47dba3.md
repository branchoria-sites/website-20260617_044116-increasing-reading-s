...
show_ads: true
description: A working outline turns headings and paragraph openings into a fast map for deciding where close reading belongs.
hero_summary: A working outline turns headings and paragraph openings into a fast map for deciding where close reading belongs.
layout: default
...
- /skimming/
- /text-map/
nav_short_title: Skim Outline
title: Build a Fast Outline Before Reading Closely
title_full: Build a Fast Outline Before Reading Closely
display_title_short: Skim Outline
display_title: Skim Outline
heading_title: Build a Fast Outline Before Reading Closely
page_heading_title: Build a Fast Outline Before Reading Closely
source_count: 46
infographic_count: 3
planned_sections:
- How to turn headings into branches
- How first sentences fill the outline
- How to choose sections for close reading
...
next_link:
  ...
  short_title: Why Topic Sentences Can Mislead Skimmers
  heading_title: Why Topic Sentences Can Mislead Skimmers
date: '2026-06-17 00:04:40 '
header:
  og_image: /assets/images/increasing_re_852ca6_honest_skimmi_aabcf8_headings_topi_0f9143_skim_outline_47dba3-Illustration-1-social.jpg
  preview_image: /assets/images/increasing_re_852ca6_honest_skimmi_aabcf8_headings_topi_0f9143_skim_outline_47dba3-Illustration-1.webp
image: /assets/images/increasing_re_852ca6_honest_skimmi_aabcf8_headings_topi_0f9143_skim_outline_47dba3-Illustration-1-social.jpg
---

## Introduction

A skim becomes far more reliable when it produces a visible outline rather than a vague impression. Instead of collecting isolated keywords, an effective reader converts headings and paragraph openings into a simple map of the document. That map shows where the author is going, how ideas connect, and which sections deserve slower attention. The result is faster reading without relying on guesswork.
...
Most nonfiction documents already contain a built-in outline. Headings and subheadings divide information into major topics and supporting topics. A reader's job is to capture that structure quickly.

Instead of reading every heading as a separate fact, treat it as a branch in a hierarchy. The main heading becomes a major topic, while subheadings become subordinate points beneath it.

For example, a report might contain:

* Causes of Urban Congestion
Population Growth
Road Design
...
A common mistake is turning the outline into detailed notes. During a skim, the outline should remain lightweight.
...
* Record headings.
* Record major subheadings.
* Avoid recording supporting evidence.
* Limit each entry to a few words.

</div>

The [purpose]({{ 'purpose/' | relative_url }}) is navigation, not documentation. A short outline can often be created in less than a minute for a long article or chapter.
...
*"Companies offering flexible schedules report lower turnover rates."*

The outline can now be expanded:

* Remote Work and Employee Retention
Flexible schedules linked to lower turnover

The reader has extracted the paragraph's role without reading the supporting statistics or examples.

This process transforms a structural skeleton into a functional summary. The outline gradually becomes a sequence of claims rather than merely a list of topics.


<img src="{{ "/assets/images/increasing_re_852ca6_honest_skimmi_aabcf8_headings_topi_0f9143_skim_outline_47dba3-Illustration-2-dark.svg" | relative_url }}" alt="Skim Outline illustration 2" data-theme-src-dark="{{ "/assets/images/increasing_re_852ca6_honest_skimmi_aabcf8_headings_topi_0f9143_skim_outline_47dba3-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/increasing_re_852ca6_honest_skimmi_aabcf8_headings_topi_0f9143_skim_outline_47dba3-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
### Look for Paragraph Functions

When reading opening sentences, focus on what job the paragraph performs.

A paragraph often serves one of several functions:

* Introducing a claim.
* Providing evidence.
* Explaining a mechanism.
* Presenting an exception.
* Describing a [limitation]({{ 'reading-limits/' | relative_url }}).
* Offering a recommendation.

Adding these functions to an outline makes later navigation much easier.
...
* Evidence for remote work benefits
* Limitation of existing studies
* Recommendation for hybrid policies

</div>

A reader who later returns to the document can immediately identify where close reading is most likely to pay off.
...
**Sections central to your purpose**

If you are reading for a decision, a recommendation section may matter more than [background]({{ 'expertise/' | relative_url }}) information. If you are preparing for an exam, explanatory sections may deserve priority.

**Sections containing evidence**

Headings that suggest data, results, research findings, or case studies often contain the information needed to evaluate a claim.

**Sections that challenge expectations**

If the outline reveals a limitation, objection, or unexpected conclusion, close reading may prevent misunderstandings.

**Sections that appear structurally important**

Long sections, repeated themes, or headings placed prominently near the beginning or end of a document often carry more weight in the overall argument.

The outline therefore becomes a filter. Rather than reading everything at the same speed, readers reserve detailed attention for the portions most relevant to their goals.


<img src="{{ "/assets/images/increasing_re_852ca6_honest_skimmi_aabcf8_headings_topi_0f9143_skim_outline_47dba3-Illustration-3-dark.svg" | relative_url }}" alt="Skim Outline illustration 3" data-theme-src-dark="{{ "/assets/images/increasing_re_852ca6_honest_skimmi_aabcf8_headings_topi_0f9143_skim_outline_47dba3-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/increasing_re_852ca6_honest_skimmi_aabcf8_headings_topi_0f9143_skim_outline_47dba3-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## A Practical Two-Minute Outline Method

For articles, [reports]({{ 'reports/' | relative_url }}), and textbook chapters, a fast implementation sequence is:


<div class="content-enhancement content-enhancement--step-flow" markdown="1">

1. Read the title and major headings.
2. Convert headings into a simple hierarchy.
3. Read the first sentence of key paragraphs.
4. Add brief notes capturing each paragraph's main point.
5. Mark sections that appear important, uncertain, or evidence-heavy.
6. Begin close reading only in those sections.
