...
- increasing_re_852ca6_reading_speed_ac88ef_reading_speed_fae94e_index
...
sibling_basenames:
- increasing_re_852ca6_reading_speed_ac88ef_fiction_vs_no_02e671
...
show_ads: true
description: A useful reading-speed test uses a realistic passage, enough time, and a comprehension check rather than a one-minute score alone.
hero_summary: A useful reading-speed test uses a realistic passage, enough time, and a comprehension check rather than a one-minute score alone.
layout: default
permalink: /self-test/
sidebar_expanded_urls:
- /increasing/
- /benchmarks/
nav_short_title: Self Test
title: A Better Way to Test Your Reading Speed
title_full: A Better Way to Test Your Reading Speed
display_title_short: Self Test
display_title: Self Test
heading_title: A Better Way to Test Your Reading Speed
page_heading_title: A Better Way to Test Your Reading Speed
source_count: 60
infographic_count: 3
planned_sections:
- Choosing a realistic passage length
- Calculating words per minute accurately
- Checking whether comprehension survived
...
next_link:
  ...
  heading_title: When Slow Reading Is a Problem
header:
  og_image: /assets/images/increasing_re_852ca6_reading_speed_ac88ef_reading_speed_fae94e-Illustration-1-social.jpg
  preview_image: /assets/images/increasing_re_852ca6_reading_speed_ac88ef_reading_speed_fae94e-Illustration-1.webp
image: /assets/images/increasing_re_852ca6_reading_speed_ac88ef_reading_speed_fae94e-Illustration-1-social.jpg
---
...
A better self-test therefore combines three elements: a realistic passage, accurate [timing]({{ 'timing/' | relative_url }}), and a meaningful comprehension check. This approach produces a benchmark that reflects how you actually read for work, study, or leisure rather than how quickly you can race through a short text.

## Choosing a Realistic Passage Length

Many online tests use a one-minute passage. These can be useful for a quick snapshot, but they often exaggerate performance because the text is short and readers can maintain unusually high concentration for a brief period.

A more realistic self-test uses a passage long enough to resemble ordinary reading. For most adults, a text of roughly 800–1,500 words works well. That is long enough for attention, [vocabulary]({{ 'knowledge/' | relative_url }}) difficulty, and natural reading habits to influence the result. If your goal is academic or professional reading, use non-fiction similar to what you normally encounter. If you mainly read novels, use narrative prose instead.
...
* Unfamiliar to you.
* Read silently rather than aloud.
* Completed in a single sitting.
* Similar in difficulty to your everyday reading material.
...
Once you have a suitable passage, [measure]({{ 'measure/' | relative_url }}) speed in a straightforward way.


<div class="content-enhancement content-enhancement--step-flow" markdown="1">

1. Count the total number of words in the passage.
2. Start a timer when you begin reading.
3. Read naturally, without deliberately rushing or slowing down.
4. Stop the timer when you finish.
5. Divide the word count by the number of minutes taken.
...
This calculation is simple, but consistency matters. Use the same conditions each time:


<div class="content-enhancement content-enhancement--phrase-pills" markdown="1">

* Similar time of day.
* Similar reading environment.
* Similar text difficulty.
* No interruptions.

</div>

Short tests often produce volatile scores. A 30-second distraction or a particularly easy paragraph can shift the result noticeably. Longer passages tend to provide a more stable estimate of your genuine reading rate.

When tracking improvement, compare averages across several tests rather than relying on a single session.
...
* Information that requires integrating multiple parts of the text.

</div>

Avoid questions that merely ask for isolated facts. Someone can remember a few details while missing the overall meaning.

As a practical guideline, aim for at least 70–80% correct answers before treating a speed score as representative of effective reading.


<img src="{{ "/assets/images/increasing_re_852ca6_reading_speed_ac88ef_reading_speed_fae94e-Illustration-2-dark.svg" | relative_url }}" alt="Self Test illustration 2" data-theme-src-dark="{{ "/assets/images/increasing_re_852ca6_reading_speed_ac88ef_reading_speed_fae94e-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/increasing_re_852ca6_reading_speed_ac88ef_reading_speed_fae94e-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
### Write a Short Summary

If no questions are available, write a summary from memory immediately after reading.
...
* The central argument or plot.
* Key supporting points.
* Important conclusions.

</div>

Compare the summary with the original text afterwards. Missing major themes often indicates that speed exceeded comprehension.

### Explain the Passage to Someone Else

Teaching or explaining material is a demanding comprehension check because it requires organising ideas rather than merely recognising them.

If you can explain the text clearly and accurately a few minutes later, comprehension is likely intact. If you struggle to reconstruct the argument, the reading rate may have been too aggressive.
...
The most informative result is not your highest score but your sustainable score.
...
Test DateWPMComprehensionTest 122092%Test 223588%Test 325090%

This combined record shows whether gains are genuine. Rising speed with stable comprehension usually reflects improved reading efficiency. Rising speed with falling comprehension often indicates increased skimming rather than improved reading.


<img src="{{ "/assets/images/increasing_re_852ca6_reading_speed_ac88ef_reading_speed_fae94e-Illustration-3-dark.svg" | relative_url }}" alt="Self Test illustration 3" data-theme-src-dark="{{ "/assets/images/increasing_re_852ca6_reading_speed_ac88ef_reading_speed_fae94e-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/increasing_re_852ca6_reading_speed_ac88ef_reading_speed_fae94e-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## Common Testing Mistakes

Several habits can inflate scores without reflecting real improvement:

* Using extremely short passages.
* Re-reading a familiar text.
* Counting skimming as full reading.
* Ignoring comprehension entirely.
* Comparing fiction scores with technical-document scores.
* Using different difficulty levels across tests.

Another common mistake is chasing a single impressive number. A reader who occasionally reaches 320 wpm but usually understands less may be less effective than one who consistently reads at 250 wpm with strong retention.

The [purpose]({{ 'purpose/' | relative_url }}) of testing is not to win a speed contest. It is to identify the fastest pace at which understanding remains reliable.
...
## A Simple Repeatable Self-Test

For most adults, an effective self-test looks like this:

1. Select an unfamiliar 1,000-word passage similar to your normal reading.
2. Read silently at a natural pace.
3. Record the time taken.
4. Calculate wpm.
5. Complete five to ten comprehension questions or write a summary.
