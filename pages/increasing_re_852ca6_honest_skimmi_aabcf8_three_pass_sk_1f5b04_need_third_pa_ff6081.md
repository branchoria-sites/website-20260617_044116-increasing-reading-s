...
show_ads: true
description: Not every report or article needs deep analysis, and knowing when to stop can save substantial reading time.
hero_summary: Not every report or article needs deep analysis, and knowing when to stop can save substantial reading time.
layout: default
...
- /skimming/
- /three-passes/
nav_short_title: Need Third Pass
title: Does This Document Really Need a Third Pass?
title_full: Does This Document Really Need a Third Pass?
display_title_short: Need Third Pass
display_title: Need Third Pass
heading_title: Does This Document Really Need a Third Pass?
page_heading_title: Does This Document Really Need a Third Pass?
source_count: 27
infographic_count: 3
planned_sections:
...
image: /assets/images/increasing_re_852ca6_honest_skimmi_aabcf8_three_pass_sk_1f5b04_need_third_pa_ff6081-Illustration-1-social.jpg
---

## Introduction

A third pass is where reading stops being reconnaissance and becomes investigation. In a [three-pass]({{ 'three-passes/' | relative_url }}) approach to nonfiction, the first pass maps the document and the second follows the argument. The third pass is reserved for documents that genuinely matter. The speed advantage comes not from reading every document faster, but from avoiding deep analysis when it is unnecessary.
...
1. Will this document influence a meaningful decision?
2. Will I need to rely on its evidence rather than merely know its conclusion?
3. Would misunderstanding it have a noticeable cost?

</div>

If the answer is "yes" to at least two, a third pass is often justified.

This test works because reading time is limited. The [purpose]({{ 'purpose/' | relative_url }}) of faster reading is not to maximise pages consumed but to allocate attention where it produces the greatest return.
...
* Industry [reports]({{ 'reports/' | relative_url }}) that confirm information you already know.
...
<img src="{{ "/assets/images/increasing_re_852ca6_honest_skimmi_aabcf8_three_pass_sk_1f5b04_need_third_pa_ff6081-Illustration-2-dark.svg" | relative_url }}" alt="Need Third Pass illustration 2" data-theme-src-dark="{{ "/assets/images/increasing_re_852ca6_honest_skimmi_aabcf8_three_pass_sk_1f5b04_need_third_pa_ff6081-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/increasing_re_852ca6_honest_skimmi_aabcf8_three_pass_sk_1f5b04_need_third_pa_ff6081-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
...
[Contradictions]({{ 'contradictions/' | relative_url }}) often require examination of methods, assumptions, or evidence.
...
<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/lsbZcXL7hrE" title="AI Summary - How to Read a Paper - S. Keshav (2016)" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=lsbZcXL7hrE" target="_blank" rel="noopener noreferrer">AI Summary - How to Read a Paper - S. Keshav (2016)</a></p><p class="youtube-embed-meta">Channel: Papers We Love - Nairobi</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=lsbZcXL7hrE" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=lsbZcXL7hrE">Open on YouTube</a></p></div></div></div>
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Useful when deciding whether evidence deserves a closer analytical pass.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Supports decisions about investing effort in careful reading and analysis.</p>
        <div class="fr-book-actions">
