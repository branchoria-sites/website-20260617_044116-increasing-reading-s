...
- increasing_re_852ca6_vocabulary_ba_236244_index
...
show_ads: true
description: Readers get faster in familiar subjects because words, concepts, and argument patterns require less effort to process.
hero_summary: Readers get faster in familiar subjects because words, concepts, and argument patterns require less effort to process.
layout: default
permalink: /knowledge/
sidebar_expanded_urls:
- /increasing/
nav_short_title: Knowledge
title: Why Familiar Topics Feel Faster to Read
title_full: Why Familiar Topics Feel Faster to Read
display_title_short: Knowledge
display_title: Knowledge
heading_title: Why Familiar Topics Feel Faster to Read
page_heading_title: Why Familiar Topics Feel Faster to Read
source_count: 131
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: The Reading Speed Test That Actually Helps
header:
  og_image: /assets/images/increasing_re_852ca6_vocabulary_ba_236244-overview-social.jpg
  preview_image: /assets/images/increasing_re_852ca6_vocabulary_ba_236244-overview.webp
image: /assets/images/increasing_re_852ca6_vocabulary_ba_236244-overview-social.jpg
---

## Introduction

Familiar topics often feel faster to read because the brain is not starting from zero. [Known words]({{ 'known-words/' | relative_url }}) are recognised more automatically, familiar concepts need less explanation, and predictable argument patterns let the reader anticipate where a sentence or paragraph is going. This does not mean background knowledge magically turns difficult prose into easy prose, or that readers can safely skim everything they know something about. It means that part of reading speed is built [before reading]({{ 'before-reading/' | relative_url }}) begins: in vocabulary, domain knowledge, and repeated exposure to how a field talks.
...
Vocabulary and background knowledge help most with the first two. The third still requires [careful reading]({{ 'careful-reading/' | relative_url }}).


<img src="{{ "/assets/images/increasing_re_852ca6_vocabulary_ba_236244-Illustration-2-dark.svg" | relative_url }}" alt="Knowledge illustration 2" data-theme-src-dark="{{ "/assets/images/increasing_re_852ca6_vocabulary_ba_236244-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/increasing_re_852ca6_vocabulary_ba_236244-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## Building fluency within a field
