...
- increasing_re_852ca6_purpose_based_25e5d2_report_skimmi_a98d6b_index
...
show_ads: true
description: Reports become faster to read when summaries, headings, tables, and conclusions point you toward the few sections that affect a decision.
hero_summary: Reports become faster to read when summaries, headings, tables, and conclusions point you toward the few sections that affect a decision.
layout: default
permalink: /reports/
...
title: How to find the parts of a report that matter
title_full: How to find the parts of a report that matter
display_title_short: Reports
display_title: Reports
heading_title: How to find the parts of a report that matter
page_heading_title: How to find the parts of a report that matter
source_count: 32
infographic_count: 3
planned_sections:
- Executive summaries, contents pages, and recommendation trails
- Tables, figures, assumptions, and caveats
- When to move from skimming to close reading
...
next_link:
  ...
  heading_title: Stop reading documentation like a novel
header:
  og_image: /assets/images/increasing_re_852ca6_purpose_based_25e5d2_report_skimmi_a98d6b-Illustration-1-social.jpg
  preview_image: /assets/images/increasing_re_852ca6_purpose_based_25e5d2_report_skimmi_a98d6b-Illustration-1.webp
image: /assets/images/increasing_re_852ca6_purpose_based_25e5d2_report_skimmi_a98d6b-Illustration-1-social.jpg
---
...
For [increasing]({{ 'increasing/' | relative_url }}) reading speed, this approach matters because it replaces blanket reading with selective attention. Instead of treating all pages as equally important, the reader follows the report's decision trail: what is being recommended, what evidence supports it, what assumptions it relies on, and what caveats could change the outcome.

## Start with the recommendation trail
...
* Mark the sections that appear to support or challenge the recommendation.

At this point, a reader often understands the report's central claim in a fraction of the time required for a full read-through.

### What you are looking for

While skimming these sections, answer four questions:

* What decision is being proposed?
* What evidence is presented as the strongest support?
* What assumptions must be true for the recommendation to work?
* What risks, uncertainties, or limitations are acknowledged?

If those questions are answered clearly, you already have a framework for deciding where close reading is worthwhile.
...
## Use tables and figures as shortcuts to the evidence

Many reports contain dozens of pages of narrative explanation surrounding a relatively small number of [key charts]({{ 'key-charts/' | relative_url }}), tables, and figures. These visual elements often reveal the evidence structure faster than paragraphs do.

A useful technique is to scan every figure title, table heading, and chart caption before reading the surrounding text. This quickly exposes:
...
Reading those first can determine whether the remaining pages deserve detailed attention.
...
## Find the assumptions before trusting the recommendation

One of the fastest ways to evaluate a report is to locate its assumptions.

Recommendations rarely stand alone. They depend on conditions such as:

* Market growth continuing.
* Costs remaining stable.
* Regulations not changing.
...
A recommendation may appear compelling until a hidden assumption is revealed. A reader who finds that assumption early can avoid spending time on details that do not materially change the decision.


<img src="{{ "/assets/images/increasing_re_852ca6_purpose_based_25e5d2_report_skimmi_a98d6b-Illustration-2-dark.svg" | relative_url }}" alt="Reports illustration 2" data-theme-src-dark="{{ "/assets/images/increasing_re_852ca6_purpose_based_25e5d2_report_skimmi_a98d6b-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/increasing_re_852ca6_purpose_based_25e5d2_report_skimmi_a98d6b-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
### A useful test

Ask:

"If this assumption turned out to be wrong, would the recommendation still make sense?"

If the answer is no, that assumption deserves close reading.

## Caveats are often more important than conclusions

Fast readers sometimes make a costly mistake: they read the recommendation but skip the caveats.
...
* Uncertain forecasts.
* Conflicts between measures.
* External factors outside the report's control.

In many professional settings, the most valuable paragraph in a report is not the conclusion but the paragraph beginning with [phrases]({{ 'phrases/' | relative_url }}) such as:
...
<img src="{{ "/assets/images/increasing_re_852ca6_purpose_based_25e5d2_report_skimmi_a98d6b-Illustration-3-dark.svg" | relative_url }}" alt="Reports illustration 3" data-theme-src-dark="{{ "/assets/images/increasing_re_852ca6_purpose_based_25e5d2_report_skimmi_a98d6b-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/increasing_re_852ca6_purpose_based_25e5d2_report_skimmi_a98d6b-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## When to move from skimming to close reading

The goal of report skimming is not to avoid detailed reading. The goal is to decide where detailed reading is justified.

Move from skimming to close reading when:

* The recommendation affects money, safety, compliance, or strategy.
* A key assumption appears uncertain.
* The evidence conflicts with the conclusion.
...
<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/MxyQKUzvuhA" title="How to Analyze a Business Case Study" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=MxyQKUzvuhA" target="_blank" rel="noopener noreferrer">How to Analyze a Business Case Study</a></p><p class="youtube-embed-meta">Channel: Steven Silverman &middot; Views: 388.4K &middot; Uploaded: February 2015 &middot; Length: 11 minutes</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=MxyQKUzvuhA" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=MxyQKUzvuhA">Open on YouTube</a></p></div></div></div>

## A practical skimming sequence for long reports
...
5. Assumptions, risks, limitations, and caveats.
6. Only then, read the most decision-relevant sections in full.

This sequence works because it follows the report's structure rather than its page numbers. The reader first identifies the decision, then the evidence, then the conditions under which that evidence should be trusted.
