...
show_ads: true
description: One-word displays can make recognition less efficient because each word arrives without the usual visual head start from nearby text.
hero_summary: One-word displays can make recognition less efficient because each word arrives without the usual visual head start from nearby text.
layout: default
...
- /reading-apps/
- /preview-loss/
nav_short_title: Harder words
title: Why every flashed word starts colder
title_full: Why every flashed word starts colder
display_title_short: Harder words
display_title: Harder words
heading_title: Why every flashed word starts colder
page_heading_title: Why every flashed word starts colder
source_count: 28
infographic_count: 3
planned_sections:
- What readers normally glimpse before fixation
- How preview benefit reduces recognition work
- Why RSVP removes the head start
...
image: /assets/images/increasing_re_852ca6_rsvp_reading_26badc_parafoveal_pr_2d360f_missing_previ_d45570-Illustration-1-social.jpg
---
...
* The visual system may have identified several letters.
* The reader may have estimated word length and shape.
* Context may have narrowed the set of likely candidates.
* Lexical processing may already have partially activated the word in memory.
...
The practical effect of preview is that word recognition becomes a continuation rather than a fresh start.
...
<img src="{{ "/assets/images/increasing_re_852ca6_rsvp_reading_26badc_parafoveal_pr_2d360f_missing_previ_d45570-Illustration-2-dark.svg" | relative_url }}" alt="Harder words illustration 2" data-theme-src-dark="{{ "/assets/images/increasing_re_852ca6_rsvp_reading_26badc_parafoveal_pr_2d360f_missing_previ_d45570-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/increasing_re_852ca6_rsvp_reading_26badc_parafoveal_pr_2d360f_missing_previ_d45570-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## Why RSVP removes the head start
...
1. One word appears.
2. The reader processes it.
3. The word disappears.
4. The next word appears.
5. Processing starts again.
...
## Why the cost grows on difficult words
...
## The hidden trade-off for reading speed
...
<p class="fr-book-desc">Covers the cognitive processes behind reading and how skilled readers achieve efficiency.</p>
...
<p class="fr-book-desc">Explains how word recognition works and why visual processing constraints matter for fluent reading.</p>
<div class="fr-book-actions">
...
<p class="fr-book-desc">Directly addresses eye movements, word recognition, and parafoveal preview effects in reading.</p>
<div class="fr-book-actions">
...
<p class="fr-book-desc">Discusses how different reading formats affect comprehension, attention, and processing.</p>
<div class="fr-book-actions">
