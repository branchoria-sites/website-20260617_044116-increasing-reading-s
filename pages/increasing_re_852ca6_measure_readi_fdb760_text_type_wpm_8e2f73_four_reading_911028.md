...
show_ads: true
description: Four separate profiles for fiction, articles, dense non-fiction, and technical texts make speed records fairer and easier to interpret.
hero_summary: Four separate profiles for fiction, articles, dense non-fiction, and technical texts make speed records fairer and easier to interpret.
layout: default
...
- /measure/
- /text-profiles/
nav_short_title: Four profiles
title: The four records every reader should keep
title_full: The four records every reader should keep
display_title_short: Four profiles
display_title: Four profiles
heading_title: The four records every reader should keep
page_heading_title: The four records every reader should keep
source_count: 38
infographic_count: 3
planned_sections:
- Choosing categories that match real reading purposes
- What to record beyond words per minute
- How to review trends across profiles
...
image: /assets/images/increasing_re_852ca6_measure_readi_fdb760_text_type_wpm_8e2f73_four_reading_911028-Illustration-1-social.jpg
---
...
The solution is to keep four separate reading-speed profiles rather than one overall record. By tracking fiction, general articles, dense non-fiction, and technical texts independently, you create [benchmarks]({{ 'benchmarks/' | relative_url }}) that reflect real reading purposes. This makes progress easier to interpret and prevents slow, careful study reading from unfairly lowering an overall score.

## Choosing categories that match real reading purposes

The most effective profiles are built around why you read, not around arbitrary difficulty labels.

A practical four-profile system looks like this:

ProfileTypical materialPrimary goalFictionNovels, short stories, narrative non-fictionFollow narrative smoothlyArticlesNews, magazines, blogs, popular scienceGather information efficientlyDense non-fictionHistory, philosophy, academic books, analytical essaysUnderstand arguments and evidenceTechnical textsTextbooks, manuals, scientific papers, professional documentationAccurate comprehension and application
...
The goal is not to create perfect academic categories. The goal is to create categories that remain stable over time so that each record compares like with like.


<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/y7oQJQKTIE4" title="How to Understand Difficult Books Step by Step" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=y7oQJQKTIE4" target="_blank" rel="noopener noreferrer">How to Understand Difficult Books Step by Step</a></p><p class="youtube-embed-meta">Channel: Lady of the Library</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=y7oQJQKTIE4" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=y7oQJQKTIE4">Open on YouTube</a></p></div></div></div>
...
* Notes about unusual difficulty.

A comprehension score does not need to be elaborate. After finishing, write three to five key points from memory and estimate how much was retained. A simple 1–5 scale is often enough.

For example:

MetricExampleProfileDense non-fictionWPM205Comprehension4/5Subject familiarityModeratePurposeStudyNotesComplex chapter with many references

This approach helps distinguish genuine improvement from easier material. A rise in speed accompanied by stable comprehension is meaningful. A rise in speed accompanied by declining recall may simply indicate rushing.

## Building the first baseline for each profile

Many readers already have enough material at home to establish their profiles.

Choose three unseen samples for each category. Aim for sessions of roughly 10–20 minutes so that temporary fluctuations have less impact on the result.
...
5. Average the three sessions.

The average becomes your baseline.

Avoid mixing categories during baseline testing. A magazine article that explains a scientific concept belongs in the articles profile if the writing is intended for a general audience. A peer-reviewed research paper belongs in the technical profile even if the topic is familiar.

The objective is consistency rather than perfect classification.

## How to review trends across profiles

Separate profiles become valuable when they reveal different patterns of progress.

Imagine a reader tracking results for six months:

ProfileStarting WPMCurrent WPMFiction250290Articles220260Dense non-fiction180205Technical texts145150

A single combined score would suggest modest overall improvement. The profile view tells a more useful story.
...
* Compare each profile only against its own history.
* Prioritise comprehension stability over raw speed gains.
* Look for long-term averages rather than individual sessions.
* Note changes in subject familiarity that may influence results.

A reader whose technical-text speed remains stable while comprehension improves may have made more meaningful progress than someone whose fiction speed rises sharply.


<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/y7ghLmcMsMY" title="How to Improve Reading Skills? | 7 Speed Reading Techniques | Exam Tips | LetsTute" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=y7ghLmcMsMY" target="_blank" rel="noopener noreferrer">How to Improve Reading Skills? | 7 Speed Reading Techniques | Exam Tips | LetsTute</a></p><p class="youtube-embed-meta">Channel: Let&#x27;stute</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=y7ghLmcMsMY" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=y7ghLmcMsMY">Open on YouTube</a></p></div></div></div>

## Common mistakes when creating reading-speed profiles

The most common error is treating all non-fiction as one category. This combines easy informational reading with highly demanding study material and obscures meaningful patterns.
...
<img src="{{ "/assets/images/increasing_re_852ca6_measure_readi_fdb760_text_type_wpm_8e2f73_four_reading_911028-Illustration-3-dark.svg" | relative_url }}" alt="Four profiles illustration 3" data-theme-src-dark="{{ "/assets/images/increasing_re_852ca6_measure_readi_fdb760_text_type_wpm_8e2f73_four_reading_911028-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/increasing_re_852ca6_measure_readi_fdb760_text_type_wpm_8e2f73_four_reading_911028-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## The four records every reader should keep

The purpose of separate reading-speed profiles is not to generate more statistics. It is to create fair comparisons.

A fiction profile measures how efficiently you move through narrative material. An articles profile reflects everyday information gathering. A dense non-fiction profile tracks your ability to process complex arguments. A technical profile measures careful understanding of specialised material.

Together, these four records provide a much clearer picture of reading development than any single words-per-minute score. Instead of asking whether you are reading faster overall, you can identify exactly where speed, comprehension, and confidence are improving—and where slower reading may actually be the correct strategy.


<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/1UduhPkqlYY" title="4 Types of Reading | Squadron Leader Jayasimha" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=1UduhPkqlYY" target="_blank" rel="noopener noreferrer">4 Types of Reading | Squadron Leader Jayasimha</a></p><p class="youtube-embed-meta">Channel: Squadron Leader Jayasimha</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=1UduhPkqlYY" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=1UduhPkqlYY">Open on YouTube</a></p></div></div></div>
...
<p class="fr-book-desc">Provides structured reading-speed tracking and practice methods.</p>
<div class="fr-book-actions">
...
<p class="fr-book-desc">Focuses on measuring and improving reading speed across materials.</p>
<div class="fr-book-actions">
...
<p class="fr-book-desc">Supports the idea that different text categories require different reading approaches.</p>
<div class="fr-book-actions">
