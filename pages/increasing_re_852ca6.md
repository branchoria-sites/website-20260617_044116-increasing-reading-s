...
show_ads: true
description: Increasing reading speed is possible, but not in the “read a book in an hour with full comprehension” sense often promised by speed-reading courses.
hero_summary: 'Increasing reading speed is possible, but not in the “read a book in an hour with full comprehension” sense often promised by speed-reading courses. A realistic goal is to become a more fluent, flexible reader: faster on familiar or low-stakes material, slower when ideas are dense, and better at choosing when to skim, scan, or read closely.'
layout: default
permalink: /increasing/
nav_short_title: Increasing
title: Increasing
title_full: Increasing
display_title_short: Increasing
display_title: Increasing
source_count: 156
infographic_count: 3
page_website_name: Faster Reading
page_banner_line: Read more fluently without falling for speed-reading hype.
site_website_name: Faster Reading
site_banner_line: Read more fluently without falling for speed-reading hype.
...
header:
  ...
  preview_image: /assets/images/increasing_re_852ca6-overview.webp
...
The useful question, then, is not “How do I force my eyes to move faster?” It is “How do I remove avoidable friction without losing meaning?” The best answer combines fluency practice, broader [vocabulary]({{ 'knowledge/' | relative_url }}) and [background]({{ 'expertise/' | relative_url }}) knowledge, smarter purpose-setting, and selective skimming. That improves the total amount you can understand in a given time, which is the form of reading speed that matters most.
...
**[Measure]({{ 'measure/' | relative_url }}) comprehension, not just pace.** A speed increase that leaves you unable to summarise the argument is not an improvement. The meaningful metric is useful understanding per unit of time.
...
1. **Preview before reading.** Spend 30–60 seconds looking at headings, opening and closing paragraphs, diagrams, and repeated terms. This gives your brain a map, which often reduces later rereading.
2. **Read in phrases, not isolated words.** The goal is not to grab whole lines at once. It is to let short meaningful groups land together: “the main cause”, “in the long term”, “the study found”. This supports fluency without pretending that comprehension is purely visual.
3. **Use a light guide if attention drifts.** Moving a finger, pen, or cursor steadily under the line can reduce wandering attention for some readers. It should set a calm rhythm, not drag your eyes faster than your understanding.
...
<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/km5njMqeIzk" title="Speed Reading Exercises - Tips on How To Read Faster" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=km5njMqeIzk" target="_blank" rel="noopener noreferrer">Speed Reading Exercises - Tips on How To Read Faster</a></p><p class="youtube-embed-meta">Channel: Iris Reading &middot; Views: 6.9K &middot; Uploaded: January 2022 &middot; Length: 9 minutes</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=km5njMqeIzk" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=km5njMqeIzk">Open on YouTube</a></p></div></div></div>
...
A third mistake is chasing words-per-minute scores without checking retention. Online tests can be motivating, but they often use [short passages]({{ 'passage-length-0559bd/' | relative_url }}) and shallow questions. A more useful test is whether, ten minutes later, you can explain the main claim, structure, and evidence in your own words.
...
<img src="{{ "/assets/images/increasing_re_852ca6-Illustration-3-dark.svg" | relative_url }}" alt="Increasing illustration 3" data-theme-src-dark="{{ "/assets/images/increasing_re_852ca6-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/increasing_re_852ca6-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
...
<section class="further-reading-section" data-page-toc-exclude aria-labelledby="further-reading-title">
  <div class="fr-section-shell">
    <div class="fr-section-header">
      ...
      <p class="fr-intro">Books and field guides related to Can You Read Faster Without Losing Meaning?. Use these as the next step if you want deeper reading beyond the article.</p>
    </div>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Directly addresses reading efficiently, skimming, inspectional reading, and comprehension.</p>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Explains mental processing limits that affect reading speed and understanding.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Covers efficient self-education and information processing.</p>
        <div class="fr-book-actions">
