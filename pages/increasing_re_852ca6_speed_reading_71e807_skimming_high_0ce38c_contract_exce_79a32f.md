...
show_ads: true
description: Small words like 'except' and 'subject to' can change what a contract actually requires.
hero_summary: Small words like 'except' and 'subject to' can change what a contract actually requires.
layout: default
...
title: The Contract Words Skimmers Miss Most
title_full: The Contract Words Skimmers Miss Most
display_title_short: Exceptions
display_title: Exceptions
heading_title: The Contract Words Skimmers Miss Most
page_heading_title: The Contract Words Skimmers Miss Most
source_count: 31
infographic_count: 3
planned_sections:
...
image: /assets/images/increasing_re_852ca6_speed_reading_71e807_skimming_high_0ce38c_contract_exce_79a32f-Illustration-1-social.jpg
---

## Introduction

[Skimming]({{ 'skimming/' | relative_url }}) is often promoted as a way to increase reading speed, but contracts expose one of its sharpest limits. In a contract, the sentence that appears to create an obligation is frequently not the sentence that determines what happens in [practice]({{ 'practice/' | relative_url }}). The real meaning may be hidden in an exception, a qualification, a defined term, or a cross-reference that appears later in the document. As a result, a reader who skims efficiently can leave with a confident but incorrect understanding of what the contract requires.
...
Exceptions become even harder to spot when they depend on [definitions]({{ 'definitions/' | relative_url }}) and cross-references.


<img src="{{ "/assets/images/increasing_re_852ca6_speed_reading_71e807_skimming_high_0ce38c_contract_exce_79a32f-Illustration-2-dark.svg" | relative_url }}" alt="Exceptions illustration 2" data-theme-src-dark="{{ "/assets/images/increasing_re_852ca6_speed_reading_71e807_skimming_high_0ce38c_contract_exce_79a32f-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/increasing_re_852ca6_speed_reading_71e807_skimming_high_0ce38c_contract_exce_79a32f-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
...
<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/AwPIsVl3gp4" title="How to Review a Contract [8 KEY TERMS to find]" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=AwPIsVl3gp4" target="_blank" rel="noopener noreferrer">How to Review a Contract [8 KEY TERMS to find]</a></p><p class="youtube-embed-meta">Channel: ContractsCounsel &middot; Views: 633 &middot; Uploaded: August 2024 &middot; Length: 5 minutes</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=AwPIsVl3gp4" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=AwPIsVl3gp4">Open on YouTube</a></p></div></div></div>
...
* Headings.
* Topic sentences.
* Repeated [phrases]({{ 'phrases/' | relative_url }}).
* Familiar structures.
...
When a clause appears important, [increasing]({{ 'increasing/' | relative_url }}) reading speed is usually less valuable than slowing down strategically.

Instead of asking, “What is the rule?”, ask:

1. **What words limit this rule?**
Look for “except”, “unless”, “other than”, and similar language.
2. **What is this clause subject to?**
Follow every “subject to” reference.
3. **Does any later provision override it?**
Pay attention to “notwithstanding” language and override clauses.
4. **Are key words defined elsewhere?**
Check whether apparently ordinary words have contractual definitions.
5. **Does the clause depend on another section?**
Read every referenced provision before forming a conclusion.
