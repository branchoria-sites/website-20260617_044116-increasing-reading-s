...
show_ads: true
description: Fast word delivery can feel like fast reading even when memory, inference, and integration have not kept up.
hero_summary: Fast word delivery can feel like fast reading even when memory, inference, and integration have not kept up.
layout: default
...
- /myths/
- /rsvp-apps/
nav_short_title: Speed Claims
title: Does RSVP Speed Feel Faster Than It Is?
title_full: Does RSVP Speed Feel Faster Than It Is?
display_title_short: Speed Claims
display_title: Speed Claims
heading_title: Does RSVP Speed Feel Faster Than It Is?
page_heading_title: Does RSVP Speed Feel Faster Than It Is?
source_count: 49
infographic_count: 3
planned_sections:
- Words per minute versus understood meaning
- Why fixed streams can raise mental load
- How to judge comprehension after RSVP
...
image: /assets/images/increasing_re_852ca6_speed_reading_71e807_rsvp_apps_rea_789d44_rsvp_speed_cl_db28fd-Illustration-1-social.jpg
---
...
**Limited recovery from confusion.** If a key phrase is missed, the stream continues. The reader must either accept the gap or interrupt the reading process.
...
Because speed metrics can be misleading, comprehension should be evaluated directly rather than assumed from WPM figures.

A useful test is to ask questions that go beyond simple word recognition:


<div class="content-enhancement content-enhancement--example" markdown="1">

* Can the main argument be summarised accurately?
* Can important details be recalled after a delay?
* Can relationships between ideas be explained?
* Can information be applied to a new example?
* Can conclusions be distinguished from supporting evidence?
