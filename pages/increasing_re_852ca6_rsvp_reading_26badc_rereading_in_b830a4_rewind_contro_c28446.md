...
show_ads: true
description: RSVP rewind buttons restore access to vanished words, but they do not match the speed, precision, or flow of a natural glance back.
hero_summary: RSVP rewind buttons restore access to vanished words, but they do not match the speed, precision, or flow of a natural glance back.
layout: default
...
- /reading-apps/
- /rereading-d239d8/
nav_short_title: Rewind limits
title: Why rewind buttons do not fix RSVP
title_full: Why rewind buttons do not fix RSVP
display_title_short: Rewind limits
display_title: Rewind limits
heading_title: Why rewind buttons do not fix RSVP
page_heading_title: Why rewind buttons do not fix RSVP
source_count: 27
infographic_count: 3
planned_sections:
...
image: /assets/images/increasing_re_852ca6_rsvp_reading_26badc_rereading_in_b830a4_rewind_contro_c28446-Illustration-1-social.jpg
---
...
<img src="{{ "/assets/images/increasing_re_852ca6_rsvp_reading_26badc_rereading_in_b830a4_rewind_contro_c28446-Illustration-2-dark.svg" | relative_url }}" alt="Rewind limits illustration 2" data-theme-src-dark="{{ "/assets/images/increasing_re_852ca6_rsvp_reading_26badc_rereading_in_b830a4_rewind_contro_c28446-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/increasing_re_852ca6_rsvp_reading_26badc_rereading_in_b830a4_rewind_contro_c28446-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## When controls interrupt comprehension instead of repairing it
...
The [limitation]({{ 'reading-limits/' | relative_url }}) is not merely a poor interface choice. It reflects a deeper challenge in the design of RSVP systems.
