...
child_basenames:
- increasing_re_852ca6_honest_skimmi_aabcf8_three_pass_sk_1f5b04_argument_mark_87fe32
- increasing_re_852ca6_honest_skimmi_aabcf8_three_pass_sk_1f5b04_index
...
show_ads: true
description: A three-pass skim separates structure, argument, and evidence so a fast read still produces a checkable understanding.
hero_summary: A three-pass skim separates structure, argument, and evidence so a fast read still produces a checkable understanding.
layout: default
permalink: /three-passes/
sidebar_expanded_urls:
- /increasing/
- /skimming/
nav_short_title: Three passes
title: A safer way to skim difficult nonfiction
title_full: A safer way to skim difficult nonfiction
display_title_short: Three passes
display_title: Three passes
heading_title: A safer way to skim difficult nonfiction
page_heading_title: A safer way to skim difficult nonfiction
source_count: 59
infographic_count: 3
planned_sections:
...
- basename: increasing_re_852ca6_honest_skimmi_aabcf8_three_pass_sk_1f5b04_argument_mark_87fe32
  title: Argument Markers | Three passes
  permalink: /argument-markers/
  short_title: Argument Markers
...
prev_link:
  ...
  heading_title: Can headings reveal the argument fast enough?
header:
  og_image: /assets/images/increasing_re_852ca6_honest_skimmi_aabcf8_three_pass_sk_1f5b04-Illustration-1-social.jpg
  preview_image: /assets/images/increasing_re_852ca6_honest_skimmi_aabcf8_three_pass_sk_1f5b04-Illustration-1.webp
image: /assets/images/increasing_re_852ca6_honest_skimmi_aabcf8_three_pass_sk_1f5b04-Illustration-1-social.jpg
---
...
For example, in a 40-page policy report, the first pass might reveal that only three sections contain findings relevant to your project. The rest can be deprioritised immediately. That is a genuine speed gain because it reduces unnecessary reading rather than simply accelerating [eye movements]({{ 'eye-tradeoff/' | relative_url }}).
...
A useful technique is to summarise each major section in [one sentence]({{ 'one-sentence/' | relative_url }}). If a document contains six major sections, you should finish the second pass with six concise statements that explain how the argument progresses from beginning to end.
...
The third pass is where honest [skimming]({{ 'skimming/' | relative_url }}) separates itself from superficial reading.
...
* Qualifications and [caveats]({{ 'caveats/' | relative_url }})
...
* Academic articles
* Government [reports]({{ 'reports/' | relative_url }})
...
<img src="{{ "/assets/images/increasing_re_852ca6_honest_skimmi_aabcf8_three_pass_sk_1f5b04-Illustration-3-dark.svg" | relative_url }}" alt="Three passes illustration 3" data-theme-src-dark="{{ "/assets/images/increasing_re_852ca6_honest_skimmi_aabcf8_three_pass_sk_1f5b04-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/increasing_re_852ca6_honest_skimmi_aabcf8_three_pass_sk_1f5b04-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## Common mistakes
...
<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/H3u3ultbjXU" title="How To Read A Paper Effectively and Efficiently [Feat. The Three Pass Approach]" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=H3u3ultbjXU" target="_blank" rel="noopener noreferrer">How To Read A Paper Effectively and Efficiently [Feat. The Three Pass Approach]</a></p><p class="youtube-embed-meta">Channel: StudyTopia</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=H3u3ultbjXU" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=H3u3ultbjXU">Open on YouTube</a></p></div></div></div>
