...
child_basenames: []
sibling_basenames:
- increasing_re_852ca6_purpose_based_25e5d2_report_skimmi_a98d6b_executive_sum_d283e9
...
show_ads: true
description: The fastest route to a report's evidence often runs through the few tables and charts that carry costs, risks, or forecasts.
hero_summary: The fastest route to a report's evidence often runs through the few tables and charts that carry costs, risks, or forecasts.
layout: default
...
- /purpose/
- /reports/
nav_short_title: Key charts
title: Which Charts Actually Change the Decision?
title_full: Which Charts Actually Change the Decision?
display_title_short: Key charts
display_title: Key charts
heading_title: Which Charts Actually Change the Decision?
page_heading_title: Which Charts Actually Change the Decision?
source_count: 34
infographic_count: 3
planned_sections:
- Finding decision critical tables first
- Reading captions before narrative sections
- Checking whether visuals support the conclusion
...
image: /assets/images/increasing_re_852ca6_purpose_based_25e5d2_report_skimmi_a98d6b_decision_char_4864d1-Illustration-1-social.jpg
---
...
The skill is not simply finding charts. It is finding the charts that carry consequences. A decorative chart may illustrate a point, while a decision-critical chart can determine whether a proposal is approved, delayed, funded, rejected, or reconsidered.

## Which Charts Actually Change the Decision?

Not every visual deserves equal attention. The fastest readers learn to separate explanatory graphics from decision-driving evidence.

Decision-critical visuals usually fall into a few recurring categories:

* **Cost and budget tables** showing spending requirements, savings, or financial trade-offs.
* **Forecast charts** projecting future outcomes under different assumptions.
...
For example, in a proposal to expand a service, twenty pages of narrative may explain market conditions and implementation details. Yet the final decision may depend primarily on three visuals:


<div class="content-enhancement content-enhancement--step-flow" markdown="1">

1. A cost projection table.
2. A demand forecast chart.
3. A risk assessment matrix.

</div>

Reading those first often provides most of the information needed to evaluate the recommendation.

## Finding Decision-Critical Tables First

Rather than reading every section sequentially, scan the report for visual evidence before committing to detailed reading.

A rapid process is:

1. Flip through the report and note every table, figure, and chart.
2. Read only their titles and captions.
3. Mark visuals containing forecasts, costs, risks, comparisons, or outcome measures.
...
<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/kXYvRR7gV2E" title="How I Research Stocks - Step-by-Step Fundamental Analysis" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=kXYvRR7gV2E" target="_blank" rel="noopener noreferrer">How I Research Stocks - Step-by-Step Fundamental Analysis</a></p><p class="youtube-embed-meta">Channel: The Plain Bagel &middot; Views: 1.2M &middot; Uploaded: June 2023 &middot; Length: 19 minutes</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=kXYvRR7gV2E" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=kXYvRR7gV2E">Open on YouTube</a></p></div></div></div>

## Read the Caption Before the Narrative

One of the fastest evidence-extraction techniques is reading captions [before reading]({{ 'before-reading/' | relative_url }}) paragraphs.

A chart's title, subtitle, caption, and footnotes often reveal:
...
* Which trend the author wants readers to notice.
...
> Revenue growth slowed despite increased marketing expenditure.
...
Once a potentially important table or chart has been identified, three questions quickly determine its value.


<img src="{{ "/assets/images/increasing_re_852ca6_purpose_based_25e5d2_report_skimmi_a98d6b_decision_char_4864d1-Illustration-2-dark.svg" | relative_url }}" alt="Key charts illustration 2" data-theme-src-dark="{{ "/assets/images/increasing_re_852ca6_purpose_based_25e5d2_report_skimmi_a98d6b_decision_char_4864d1-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/increasing_re_852ca6_purpose_based_25e5d2_report_skimmi_a98d6b_decision_char_4864d1-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
### What decision does this visual support?

Every important visual exists to justify or challenge a recommendation.

A forecast chart may support expansion. A risk chart may support caution. A performance dashboard may support maintaining the current strategy.

If the connection between the visual and the recommendation is unclear, the visual may be less important than it appears.

### What assumption is hidden inside it?

Many influential charts depend on assumptions that are easy to overlook.
...
The visual may look authoritative while resting on assumptions that deserve scrutiny. A single assumption can sometimes matter more than the chart's precise numbers.


<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/fTxijtVxcWE" title="Visualización de datos para la toma de decisiones en Power BI" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=fTxijtVxcWE" target="_blank" rel="noopener noreferrer">Visualización de datos para la toma de decisiones en Power BI</a></p><p class="youtube-embed-meta">Channel: Educación Continua Uniandes - EdcoUniandes</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=fTxijtVxcWE" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=fTxijtVxcWE">Open on YouTube</a></p></div></div></div>
...
* Would a lower growth rate eliminate projected benefits?
* Would a higher cost estimate remove expected savings?
* Would a different risk assessment reverse the recommendation?

</div>

Decision-relevant visuals often become much clearer when viewed as tests of sensitivity rather than fixed predictions.

## Checking Whether the Visual Supports the Conclusion

Fast readers should never assume that a chart automatically proves the point being made.

Several [warning signs]({{ 'warning-signs/' | relative_url }}) deserve attention:


<div class="content-enhancement content-enhancement--insight-grid" markdown="1">

* The conclusion is stronger than the evidence shown.
* A chart displays correlation while the text implies causation.
* Important uncertainty ranges are omitted.
* Only favourable scenarios are presented.
* The chart's scale exaggerates small differences.
* The visual highlights a trend that appears weaker when examined closely.
...
"Would I reach the same conclusion from the chart alone?"

If the answer is no, the report may require closer reading before any decision is made.


<img src="{{ "/assets/images/increasing_re_852ca6_purpose_based_25e5d2_report_skimmi_a98d6b_decision_char_4864d1-Illustration-3-dark.svg" | relative_url }}" alt="Key charts illustration 3" data-theme-src-dark="{{ "/assets/images/increasing_re_852ca6_purpose_based_25e5d2_report_skimmi_a98d6b_decision_char_4864d1-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/increasing_re_852ca6_purpose_based_25e5d2_report_skimmi_a98d6b_decision_char_4864d1-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## When Tables Beat Charts

Fast readers often focus on charts because they appear easier to digest. However, some of the most important evidence appears in tables.

Tables are especially valuable when decisions depend on:
...
* Confidence levels or evidence quality.
...
<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/2Z82ivk6FF4" title="Data Analytics | Data Visualization for Decision-Making: Creating Impactful Visuals | Webinar" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=2Z82ivk6FF4" target="_blank" rel="noopener noreferrer">Data Analytics | Data Visualization for Decision-Making: Creating Impactful Visuals | Webinar</a></p><p class="youtube-embed-meta">Channel: 360DigiTMG</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=2Z82ivk6FF4" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=2Z82ivk6FF4">Open on YouTube</a></p></div></div></div>

## The Speed-Reading Payoff

The fastest route through a report rarely follows page order. It follows the evidence trail. By locating the few tables and charts that contain costs, risks, forecasts, or outcome comparisons, a reader can often understand the practical implications of a report long before reading its detailed explanations.
...
<p class="fr-book-desc">Directly helps readers interpret charts and decision-critical visuals.</p>
<div class="fr-book-actions">
...
<p class="fr-book-desc">Teaches readers to evaluate chart credibility.</p>
<div class="fr-book-actions">
...
<p class="fr-book-desc">Shows how evidence visuals support decisions.</p>
<div class="fr-book-actions">
