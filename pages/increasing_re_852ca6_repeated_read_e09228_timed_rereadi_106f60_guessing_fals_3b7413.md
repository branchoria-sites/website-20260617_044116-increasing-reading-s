...
show_ads: true
description: Skipping endings, guessing from first letters, and memorising a passage can create fast scores without stronger reading.
hero_summary: Skipping endings, guessing from first letters, and memorising a passage can create fast scores without stronger reading.
layout: default
permalink: /guessing/
...
title: When faster rereading is really guessing
title_full: When faster rereading is really guessing
display_title_short: Guessing
display_title: Guessing
heading_title: When faster rereading is really guessing
page_heading_title: When faster rereading is really guessing
source_count: 44
infographic_count: 3
planned_sections:
...
<img src="{{ "/assets/images/increasing_re_852ca6_repeated_read_e09228_timed_rereadi_106f60_guessing_fals_3b7413-Illustration-2-dark.svg" | relative_url }}" alt="Guessing illustration 2" data-theme-src-dark="{{ "/assets/images/increasing_re_852ca6_repeated_read_e09228_timed_rereadi_106f60_guessing_fals_3b7413-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/increasing_re_852ca6_repeated_read_e09228_timed_rereadi_106f60_guessing_fals_3b7413-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## How fresh passages expose memorisation
...
The third outcome can be discouraging, but it is valuable feedback. It identifies where [practice]({{ 'practice/' | relative_url }}) has become a memory exercise rather than a reading exercise.
