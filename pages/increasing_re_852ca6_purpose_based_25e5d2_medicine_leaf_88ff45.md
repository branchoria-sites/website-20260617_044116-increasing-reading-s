...
- increasing_re_852ca6_purpose_based_25e5d2_medicine_leaf_88ff45_index
...
show_ads: true
description: Medicine leaflets can be skimmed for layout, but dosage, interactions, urgent side effects, and do-not-take warnings deserve close reading.
hero_summary: Medicine leaflets can be skimmed for layout, but dosage, interactions, urgent side effects, and do-not-take warnings deserve close reading.
layout: default
permalink: /medicine-leaflets/
sidebar_expanded_urls:
- /increasing/
- /purpose/
nav_short_title: Medicine leaflets
title: The leaflet sections you should not skim
title_full: The leaflet sections you should not skim
display_title_short: Medicine leaflets
display_title: Medicine leaflets
heading_title: The leaflet sections you should not skim
page_heading_title: The leaflet sections you should not skim
source_count: 41
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: How to find the parts of a report that matter
header:
  og_image: /assets/images/increasing_re_852ca6_purpose_based_25e5d2_medicine_leaf_88ff45-Illustration-1-social.jpg
  preview_image: /assets/images/increasing_re_852ca6_purpose_based_25e5d2_medicine_leaf_88ff45-Illustration-1.webp
image: /assets/images/increasing_re_852ca6_purpose_based_25e5d2_medicine_leaf_88ff45-Illustration-1-social.jpg
---
...
The fastest effective approach is selective reading: scan the leaflet structure first, then [slow down]({{ 'slow-down/' | relative_url }}) dramatically when you reach instructions that affect what you take, when you take it, what you should avoid, and when you should seek medical help.
...
Many people skim past the [missed-dose]({{ 'missed-doses/' | relative_url }}) section because they think the answer is obvious. In reality, instructions vary considerably between medicines.
...
<img src="{{ "/assets/images/increasing_re_852ca6_purpose_based_25e5d2_medicine_leaf_88ff45-Illustration-2-dark.svg" | relative_url }}" alt="Medicine leaflets illustration 2" data-theme-src-dark="{{ "/assets/images/increasing_re_852ca6_purpose_based_25e5d2_medicine_leaf_88ff45-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/increasing_re_852ca6_purpose_based_25e5d2_medicine_leaf_88ff45-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## Warnings that change what you should do next
...
<img src="{{ "/assets/images/increasing_re_852ca6_purpose_based_25e5d2_medicine_leaf_88ff45-Illustration-3-dark.svg" | relative_url }}" alt="Medicine leaflets illustration 3" data-theme-src-dark="{{ "/assets/images/increasing_re_852ca6_purpose_based_25e5d2_medicine_leaf_88ff45-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/increasing_re_852ca6_purpose_based_25e5d2_medicine_leaf_88ff45-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
...
1. Read the medicine name and confirm it matches the product received.
2. Scan the contents and section headings.
3. Read "Do not take" and warning sections carefully.
4. Read dosage and administration instructions slowly.
5. Read interaction warnings carefully.
6. Read missed-dose and overdose instructions.
7. Identify side effects that require urgent action.
8. Skim the remaining reference information as needed.
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Provides context for treatment decisions and medication guidance.</p>
