...
- increasing_re_852ca6_vocabulary_ba_236244_familiarity_o_f1d5d7_index
...
show_ads: true
description: Background knowledge can make reading smoother, but it can also tempt readers to skim past exceptions, nuance and disagreement.
hero_summary: Background knowledge can make reading smoother, but it can also tempt readers to skim past exceptions, nuance and disagreement.
layout: default
permalink: /easy-trap/
sidebar_expanded_urls:
- /increasing/
- /knowledge/
nav_short_title: Easy Trap
title: When Familiar Topics Make You Too Fast
title_full: When Familiar Topics Make You Too Fast
display_title_short: Easy Trap
display_title: Easy Trap
heading_title: When Familiar Topics Make You Too Fast
page_heading_title: When Familiar Topics Make You Too Fast
source_count: 27
infographic_count: 3
planned_sections:
...
image: /assets/images/increasing_re_852ca6_vocabulary_ba_236244_familiarity_o_f1d5d7-Illustration-1-social.jpg
---

## Introduction

[Background]({{ 'expertise/' | relative_url }}) knowledge is one of the most reliable ways to increase reading speed. Familiar [vocabulary]({{ 'knowledge/' | relative_url }}), known concepts and predictable structures reduce the amount of effort required to understand a text. The problem is that the same familiarity that makes reading faster can also make readers less careful.
...
<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/PUIj0Ax2jYQ" title="Stop Wasting Time Reading: The Neuroscience of Real Learning" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=PUIj0Ax2jYQ" target="_blank" rel="noopener noreferrer">Stop Wasting Time Reading: The Neuroscience of Real Learning</a></p><p class="youtube-embed-meta">Channel: Prof. Joseph Ponniah, NIT</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=PUIj0Ax2jYQ" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=PUIj0Ax2jYQ">Open on YouTube</a></p></div></div></div>
...
Several [warning signs]({{ 'warning-signs/' | relative_url }}) suggest that familiarity may be creating overconfidence:

### When the Author Uses Unexpected Language

If a familiar term appears to be used differently than usual, slow down. Changes in [definitions]({{ 'definitions/' | relative_url }}) often signal the most important part of an argument.
