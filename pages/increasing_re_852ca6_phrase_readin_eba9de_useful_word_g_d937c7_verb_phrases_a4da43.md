...
show_ads: true
description: Recognising the full verb group helps readers understand tense, timing, and action without unnecessary pauses.
hero_summary: Recognising the full verb group helps readers understand tense, timing, and action without unnecessary pauses.
layout: default
...
- /phrases/
- /word-groups/
nav_short_title: Verb Phrases
title: How verb groups reveal the real action
title_full: How verb groups reveal the real action
display_title_short: Verb Phrases
display_title: Verb Phrases
heading_title: How verb groups reveal the real action
page_heading_title: How verb groups reveal the real action
source_count: 35
infographic_count: 3
planned_sections:
...
image: /assets/images/increasing_re_852ca6_phrase_readin_eba9de_useful_word_g_d937c7_verb_phrases_a4da43-Illustration-1-social.jpg
---

## Introduction

One of the fastest ways to improve reading speed without sacrificing understanding is to recognise complete verb [phrases]({{ 'phrases/' | relative_url }}) rather than treating each verb-like word separately. In many sentences, the main action is carried by a group of words, not by a single verb. Phrases such as *has been working*, *will be completed*, or *might have forgotten* communicate action, time, and certainty as a single unit. When readers learn to see these groups instantly, they spend less effort piecing together grammar and more effort following meaning.
...
Readers who immediately capture the whole phrase understand [timing]({{ 'timing/' | relative_url }}) without stopping to reinterpret the sentence. This reduces rereading and helps maintain reading momentum.
...
<img src="{{ "/assets/images/increasing_re_852ca6_phrase_readin_eba9de_useful_word_g_d937c7_verb_phrases_a4da43-Illustration-2-dark.svg" | relative_url }}" alt="Verb Phrases illustration 2" data-theme-src-dark="{{ "/assets/images/increasing_re_852ca6_phrase_readin_eba9de_useful_word_g_d937c7_verb_phrases_a4da43-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/increasing_re_852ca6_phrase_readin_eba9de_useful_word_g_d937c7_verb_phrases_a4da43-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
...
These longer verb groups often cause readers to [slow down]({{ 'slow-down/' | relative_url }}) unnecessarily because they appear grammatically complex. In [practice]({{ 'practice/' | relative_url }}), they function as a single meaning unit.
...
<img src="{{ "/assets/images/increasing_re_852ca6_phrase_readin_eba9de_useful_word_g_d937c7_verb_phrases_a4da43-Illustration-3-dark.svg" | relative_url }}" alt="Verb Phrases illustration 3" data-theme-src-dark="{{ "/assets/images/increasing_re_852ca6_phrase_readin_eba9de_useful_word_g_d937c7_verb_phrases_a4da43-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/increasing_re_852ca6_phrase_readin_eba9de_useful_word_g_d937c7_verb_phrases_a4da43-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
