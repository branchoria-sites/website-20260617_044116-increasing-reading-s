...
show_ads: true
description: Ambiguous sentences can make readers look back to repair a first interpretation that no longer fits the words on the page.
hero_summary: Ambiguous sentences can make readers look back to repair a first interpretation that no longer fits the words on the page.
layout: default
...
- /myths/
- /lookbacks/
nav_short_title: Ambiguity
title: Why Confusing Sentences Make Eyes Look Back
title_full: Why Confusing Sentences Make Eyes Look Back
display_title_short: Ambiguity
display_title: Ambiguity
heading_title: Why Confusing Sentences Make Eyes Look Back
page_heading_title: Why Confusing Sentences Make Eyes Look Back
source_count: 30
infographic_count: 3
planned_sections:
...
image: /assets/images/increasing_re_852ca6_speed_reading_71e807_regressions_r_724139_ambiguity_loo_c1046e-Illustration-1-social.jpg
---
...
The clearest demonstration of ambiguity-driven [lookbacks]({{ 'lookbacks/' | relative_url }}) comes from so-called [garden-path]({{ 'garden-paths/' | relative_url }}) sentences. These sentences encourage a highly plausible interpretation that later turns out to be wrong.
...
<img src="{{ "/assets/images/increasing_re_852ca6_speed_reading_71e807_regressions_r_724139_ambiguity_loo_c1046e-Illustration-2-dark.svg" | relative_url }}" alt="Ambiguity illustration 2" data-theme-src-dark="{{ "/assets/images/increasing_re_852ca6_speed_reading_71e807_regressions_r_724139_ambiguity_loo_c1046e-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/increasing_re_852ca6_speed_reading_71e807_regressions_r_724139_ambiguity_loo_c1046e-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Explains predictive processing during reading.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Provides context for how meaning is constructed during reading.</p>
        <div class="fr-book-actions">
