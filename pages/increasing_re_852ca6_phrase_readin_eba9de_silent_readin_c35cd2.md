...
- increasing_re_852ca6_phrase_readin_eba9de_silent_readin_c35cd2_index
...
show_ads: true
description: Even silent readers often use an inner rhythm that helps them follow syntax, emphasis, and meaning across a sentence.
hero_summary: Even silent readers often use an inner rhythm that helps them follow syntax, emphasis, and meaning across a sentence.
layout: default
permalink: /inner-rhythm/
sidebar_expanded_urls:
- /increasing/
- /phrases/
nav_short_title: Inner Rhythm
title: Why silent reading still has rhythm
title_full: Why silent reading still has rhythm
display_title_short: Inner Rhythm
display_title: Inner Rhythm
heading_title: Why silent reading still has rhythm
page_heading_title: Why silent reading still has rhythm
source_count: 51
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: Phrase reading is not magic speed reading
header:
  og_image: /assets/images/increasing_re_852ca6_phrase_readin_eba9de_silent_readin_c35cd2-Illustration-1-social.jpg
  preview_image: /assets/images/increasing_re_852ca6_phrase_readin_eba9de_silent_readin_c35cd2-Illustration-1.webp
image: /assets/images/increasing_re_852ca6_phrase_readin_eba9de_silent_readin_c35cd2-Illustration-1-social.jpg
---
...
Popular [speed-reading]({{ 'myths/' | relative_url }}) advice often presents the inner voice as an obstacle. The argument is simple: if speech is slower than vision, then eliminating internal speech should dramatically increase reading speed.
...
Several [warning signs]({{ 'warning-signs/' | relative_url }}) suggest that reading speed has outpaced useful prosody:
