...
show_ads: true
description: Marked text is more useful when a skilled reader models natural phrasing before students reread the passage themselves.
hero_summary: Marked text is more useful when a skilled reader models natural phrasing before students reread the passage themselves.
layout: default
...
- /phrases/
- /cued-text/
nav_short_title: Modelled Reading
title: Why Slashes Need a Fluent Voice
title_full: Why Slashes Need a Fluent Voice
display_title_short: Modelled Reading
display_title: Modelled Reading
heading_title: Why Slashes Need a Fluent Voice
page_heading_title: Why Slashes Need a Fluent Voice
source_count: 38
infographic_count: 3
planned_sections:
- What modelling adds beyond printed marks
- How guided rereading reinforces phrasing
- Common modelling mistakes that flatten expression
...
image: /assets/images/increasing_re_852ca6_phrase_readin_eba9de_phrase_cued_t_f59b4d_teacher_model_41f310-Illustration-1-social.jpg
---
...
When a teacher reads a phrase-cued passage aloud before students practise it, learners hear several features that are difficult to convey through markings alone:


<div class="content-enhancement content-enhancement--insight-grid" markdown="1">

* How phrases connect into complete ideas rather than isolated chunks.
...
This progression reflects the temporary nature of the scaffold. The objective is not mastery of slash-marked text. The objective is transferring appropriate phrasing to ordinary text.

Some classrooms also use choral reading, echo reading, or assisted reading after teacher modelling. In each case, the model serves as a reference point that students attempt to reproduce through [guided practice]({{ 'guided-practice/' | relative_url }}). [jimwrightonline.com+2thecttl.org](https://www.jimwrightonline.com/mixed_files/pei/2_reading_intvs_PPT.pdf)

## Common Modelling Mistakes That Flatten Expression

Not all modelling supports fluency equally well. Several instructional mistakes can undermine the purpose of phrase-cued passages.

### Reading the Slashes Instead of the Meaning

Some teachers unintentionally exaggerate every marked boundary. Students then learn to stop mechanically at each slash, even when the sentence should flow smoothly. The goal is meaningful phrasing, not robotic pausing. Phrase boundaries represent language units rather than mandatory stopping points. [literacy.virginia.edu](https://literacy.virginia.edu/sites/literacy/files/2023-05/the_reading_sourcebook_phrase_cued_reading_1.pdf)

### Treating Speed as the Main Objective

When modelling emphasises rapid reading, students may rush through phrases without understanding them. Research on fluency consistently treats rate as only one component alongside accuracy and expression. A faster but less meaningful reading is not the intended outcome. [Reading Rockets+2Reading Rockets](https://www.readingrockets.org/reading-101/reading-and-writing-basics/fluency)

### Overperforming the Text

Excessively dramatic reading can also be unhelpful. Students need a model that sounds natural and meaning-focused rather than theatrical. The purpose is to demonstrate how written language maps onto spoken language, not to create a stage performance. [Shanahan on Literacy](https://www.shanahanonliteracy.com/blog/modeling-in-fluency-instruction)

### Providing the Model Too Far Ahead of Practice

Research-informed fluency instruction generally works best when modelling is followed quickly by student practice. If students hear a model but do not immediately attempt the passage themselves, much of the instructional value can be lost. [Shanahan on Literacy](https://www.shanahanonliteracy.com/blog/modeling-in-fluency-instruction)

## When the Scaffold Starts to Disappear

A useful sign that modelling is working is that students become less dependent on both the teacher's voice and the visual markings. They begin to recognise phrase boundaries in ordinary text and read with more natural expression even when no cues are present.
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Directly addresses oral reading, modeling, repeated reading, phrasing, and fluency development.</p>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Covers text phrasing, tonality, echo reading, repeated reading, and fluency-building routines.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Explains effective fluency instruction and the role of modeled expressive reading.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Provides wider reading-instruction context that supports fluency, modeling, and evidence-based practice.</p>
        <div class="fr-book-actions">
