...
show_ads: true
description: Important email commitments often hide in action verbs, dates, attachments, calendar changes, or the final sentence of the message.
hero_summary: Important email commitments often hide in action verbs, dates, attachments, calendar changes, or the final sentence of the message.
layout: default
...
- /purpose/
- /email-triage/
nav_short_title: Hidden Actions
title: Where email commitments hide in plain sight
title_full: Where email commitments hide in plain sight
display_title_short: Hidden Actions
display_title: Hidden Actions
heading_title: Where email commitments hide in plain sight
page_heading_title: Where email commitments hide in plain sight
source_count: 84
infographic_count: 3
planned_sections:
...
image: /assets/images/increasing_re_852ca6_purpose_based_25e5d2_email_triage_c9e704_hidden_email_66beb2-Illustration-1-social.jpg
---

## Introduction

Fast email reading is not primarily about moving your eyes across text more quickly. In a busy inbox, the real challenge is spotting obligations before they disappear into [background]({{ 'expertise/' | relative_url }}) information. Many missed commitments occur because the actual request is hidden inside a long explanation, an attachment, a meeting update, or a single sentence near the end of the message.
...
Many emails contain several paragraphs of context but only [one sentence]({{ 'one-sentence/' | relative_url }}) that actually matters. That sentence usually contains an action verb.

When [scanning]({{ 'scanning-vs-reading/' | relative_url }}) an email, action verbs often reveal the sender's expectation faster than any other clue. Common examples include:
...
<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/moIucWGgvMc" title="Write Professional Emails in English | Step-by-Step" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=moIucWGgvMc" target="_blank" rel="noopener noreferrer">Write Professional Emails in English | Step-by-Step</a></p><p class="youtube-embed-meta">Channel: Speak Confident English</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=moIucWGgvMc" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=moIucWGgvMc">Open on YouTube</a></p></div></div></div>
...
<img src="{{ "/assets/images/increasing_re_852ca6_purpose_based_25e5d2_email_triage_c9e704_hidden_email_66beb2-Illustration-2-dark.svg" | relative_url }}" alt="Hidden Actions illustration 2" data-theme-src-dark="{{ "/assets/images/increasing_re_852ca6_purpose_based_25e5d2_email_triage_c9e704_hidden_email_66beb2-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/increasing_re_852ca6_purpose_based_25e5d2_email_triage_c9e704_hidden_email_66beb2-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
...
often indicate hidden [timing]({{ 'timing/' | relative_url }}) requirements. Missing them can be as costly as overlooking an explicit due date.
...
<img src="{{ "/assets/images/increasing_re_852ca6_purpose_based_25e5d2_email_triage_c9e704_hidden_email_66beb2-Illustration-3-dark.svg" | relative_url }}" alt="Hidden Actions illustration 3" data-theme-src-dark="{{ "/assets/images/increasing_re_852ca6_purpose_based_25e5d2_email_triage_c9e704_hidden_email_66beb2-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/increasing_re_852ca6_purpose_based_25e5d2_email_triage_c9e704_hidden_email_66beb2-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## Attachments and final lines that change the task
...
> We reviewed several vendor proposals and completed [technical]({{ 'technical-texts/' | relative_url }}) assessments. Finance evaluated the costs and legal reviewed the terms. The preferred option is attached. Could you approve the recommendation by Wednesday?
