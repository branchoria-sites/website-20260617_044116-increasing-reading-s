...
show_ads: true
description: Methods sections feel slow because they hide assumptions about designs, controls, measurements and statistics that experts already know.
hero_summary: Methods sections feel slow because they hide assumptions about designs, controls, measurements and statistics that experts already know.
layout: default
...
- /dense-texts/
- /expertise/
nav_short_title: Methods drag
title: Why Methods Sections Feel So Slow
title_full: Why Methods Sections Feel So Slow
display_title_short: Methods drag
display_title: Methods drag
heading_title: Why Methods Sections Feel So Slow
page_heading_title: Why Methods Sections Feel So Slow
source_count: 32
infographic_count: 3
planned_sections:
...
image: /assets/images/increasing_re_852ca6_dense_materia_3cc00e_background_kn_3a104a_methods_secti_5e2c99-Illustration-1-social.jpg
---
...
Many newcomers assume that statistics are a separate challenge from reading. In [practice]({{ 'practice/' | relative_url }}), statistical knowledge is deeply embedded within methods sections.

A methods paragraph may mention confidence intervals, regression [models]({{ 'models/' | relative_url }}), analysis of variance, mixed-effects models or non-parametric tests in only a few words. For experts, those terms immediately communicate assumptions about data structure and analytical strategy.
...
<img src="{{ "/assets/images/increasing_re_852ca6_dense_materia_3cc00e_background_kn_3a104a_methods_secti_5e2c99-Illustration-3-dark.svg" | relative_url }}" alt="Methods drag illustration 3" data-theme-src-dark="{{ "/assets/images/increasing_re_852ca6_dense_materia_3cc00e_background_kn_3a104a_methods_secti_5e2c99-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/increasing_re_852ca6_dense_materia_3cc00e_background_kn_3a104a_methods_secti_5e2c99-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## The real lesson for reading speed

Methods sections reveal an important truth about [increasing]({{ 'increasing/' | relative_url }}) reading speed: speed is often a consequence of understanding rather than a separate skill.
...
<p class="fr-book-desc">Directly teaches readers how to decode study design, methods, statistics, and research quality.</p>
<div class="fr-book-actions">
...
<p class="fr-book-desc">Builds understanding of research logic, inference, and study design that make methods sections easier to interpret.</p>
<div class="fr-book-actions">
...
<p class="fr-book-desc">Helps readers understand the methodological choices that methods sections compress into shorthand.</p>
<div class="fr-book-actions">
