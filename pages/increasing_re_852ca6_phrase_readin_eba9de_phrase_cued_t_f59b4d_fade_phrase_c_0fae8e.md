...
show_ads: true
description: Phrase cues work best when readers move from marked passages to ordinary text before the markings become a crutch.
hero_summary: Phrase cues work best when readers move from marked passages to ordinary text before the markings become a crutch.
layout: default
permalink: /fade-cues/
...
- /phrases/
- /cued-text/
nav_short_title: Fade Cues
title: When Should Phrase Cues Disappear?
title_full: When Should Phrase Cues Disappear?
display_title_short: Fade Cues
display_title: Fade Cues
heading_title: When Should Phrase Cues Disappear?
page_heading_title: When Should Phrase Cues Disappear?
source_count: 27
infographic_count: 3
planned_sections:
...
next_link:
  ...
  short_title: Modelled Reading
  heading_title: Why Slashes Need a Fluent Voice
date: '2026-06-17 02:23:46 '
header:
  og_image: /assets/images/increasing_re_852ca6_phrase_readin_eba9de_phrase_cued_t_f59b4d_fade_phrase_c_0fae8e-Illustration-1-social.jpg
  preview_image: /assets/images/increasing_re_852ca6_phrase_readin_eba9de_phrase_cued_t_f59b4d_fade_phrase_c_0fae8e-Illustration-1.webp
image: /assets/images/increasing_re_852ca6_phrase_readin_eba9de_phrase_cued_t_f59b4d_fade_phrase_c_0fae8e-Illustration-1-social.jpg
---
...
For readers working to increase reading speed, the [timing]({{ 'timing/' | relative_url }}) of this transition matters. Remove support too early and reading may become choppy again. Keep it too long and improvement may stay tied to marked passages rather than transferring to normal books and articles. The key is to fade cues when evidence shows that phrasing is becoming automatic.
...
A simple [transfer]({{ 'transfer/' | relative_url }}) check is to compare performance on a marked passage and an equivalent unmarked passage. The reader does not need identical performance on both texts, but major differences suggest that the cues are still carrying too much of the workload.
...
<img src="{{ "/assets/images/increasing_re_852ca6_phrase_readin_eba9de_phrase_cued_t_f59b4d_fade_phrase_c_0fae8e-Illustration-3-dark.svg" | relative_url }}" alt="Fade Cues illustration 3" data-theme-src-dark="{{ "/assets/images/increasing_re_852ca6_phrase_readin_eba9de_phrase_cued_t_f59b4d_fade_phrase_c_0fae8e-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/increasing_re_852ca6_phrase_readin_eba9de_phrase_cued_t_f59b4d_fade_phrase_c_0fae8e-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
...
<p class="fr-book-desc">Directly addresses reading fluency, phrasing, repeated reading, and the transition toward independent fluent reading.</p>
...
<p class="fr-book-desc">Provides extensive fluency-building practices that align with fading scaffolds such as phrase-cued text.</p>
<div class="fr-book-actions">
...
<p class="fr-book-desc">Offers practical approaches for building fluent, independent reading once supports are reduced.</p>
<div class="fr-book-actions">
