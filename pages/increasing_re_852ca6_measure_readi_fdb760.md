...
child_basenames:
- increasing_re_852ca6_measure_readi_fdb760_index
...
show_ads: true
description: A useful reading-speed test pairs words per minute with recall, summary, and the type of text being read.
hero_summary: A useful reading-speed test pairs words per minute with recall, summary, and the type of text being read.
layout: default
permalink: /measure/
sidebar_expanded_urls:
- /increasing/
nav_short_title: Measure
title: The Reading Speed Test That Actually Helps
title_full: The Reading Speed Test That Actually Helps
display_title_short: Measure
display_title: Measure
heading_title: The Reading Speed Test That Actually Helps
page_heading_title: The Reading Speed Test That Actually Helps
source_count: 126
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: Why Speed Reading Promises Fall Apart
header:
  og_image: /assets/images/increasing_re_852ca6_measure_readi_fdb760-overview-social.jpg
  preview_image: /assets/images/increasing_re_852ca6_measure_readi_fdb760-overview.webp
image: /assets/images/increasing_re_852ca6_measure_readi_fdb760-overview-social.jpg
---

## Introduction

A reading speed test only helps if it measures what speed is for: getting meaning from text. The useful score is not simply “words per minute”, but “words per minute on this kind of text, with this level of understanding afterwards”. A fair progress check therefore pairs [timing]({{ 'timing/' | relative_url }}) with a recall, summary, or question task, and keeps separate records for easy articles, dense non-fiction, [technical]({{ 'technical-texts/' | relative_url }}) material, and fiction.
...
<img src="{{ "/assets/images/increasing_re_852ca6_measure_readi_fdb760-Illustration-2-dark.svg" | relative_url }}" alt="Measure illustration 2" data-theme-src-dark="{{ "/assets/images/increasing_re_852ca6_measure_readi_fdb760-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/increasing_re_852ca6_measure_readi_fdb760-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
...
**Useful but limited improvement:** WPM stays similar, but comprehension improves. This often happens with dense material when [vocabulary]({{ 'knowledge/' | relative_url }}), background knowledge, or strategy is improving before speed follows.
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Directly addresses reading rate and performance.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Includes methods for tracking and improving reading speed.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Balances speed with comprehension and reflection.</p>
        <div class="fr-book-actions">
