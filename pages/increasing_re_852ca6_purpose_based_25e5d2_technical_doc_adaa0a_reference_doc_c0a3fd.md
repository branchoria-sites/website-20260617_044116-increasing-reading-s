...
show_ads: true
description: Reference pages work best when you arrive with a precise question, search within the page, and inspect nearby limits or exceptions.
hero_summary: Reference pages work best when you arrive with a precise question, search within the page, and inspect nearby limits or exceptions.
layout: default
...
- /purpose/
- /tech-docs/
nav_short_title: Reference Lookup
title: Stop Reading Reference Pages Front to Back
title_full: Stop Reading Reference Pages Front to Back
display_title_short: Reference Lookup
display_title: Reference Lookup
heading_title: Stop Reading Reference Pages Front to Back
page_heading_title: Stop Reading Reference Pages Front to Back
source_count: 35
infographic_count: 3
planned_sections:
...
image: /assets/images/increasing_re_852ca6_purpose_based_25e5d2_technical_doc_adaa0a_reference_doc_c0a3fd-Illustration-1-social.jpg
---
...
<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/39Tt1IkLiQQ" title="API Documentation and Why it Matters" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=39Tt1IkLiQQ" target="_blank" rel="noopener noreferrer">API Documentation and Why it Matters</a></p><p class="youtube-embed-meta">Channel: AltexSoft | TravelTech, AI &amp; Software Engineering</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=39Tt1IkLiQQ" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=39Tt1IkLiQQ">Open on YouTube</a></p></div></div></div>
...
* What values are accepted by this parameter?
* Which error code indicates token expiration?
* Is this command available in version 3.2?
...
1. State the question in [one sentence]({{ 'one-sentence/' | relative_url }}).
2. Identify the likely keyword.
3. Use page search (`Ctrl+F` or equivalent).
4. Jump directly to the matching section.
5. Verify nearby conditions and [exceptions]({{ 'exceptions/' | relative_url }}).
...
<img src="{{ "/assets/images/increasing_re_852ca6_purpose_based_25e5d2_technical_doc_adaa0a_reference_doc_c0a3fd-Illustration-2-dark.svg" | relative_url }}" alt="Reference Lookup illustration 2" data-theme-src-dark="{{ "/assets/images/increasing_re_852ca6_purpose_based_25e5d2_technical_doc_adaa0a_reference_doc_c0a3fd-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/increasing_re_852ca6_purpose_based_25e5d2_technical_doc_adaa0a_reference_doc_c0a3fd-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## What to Check Around the Matching Answer
...
* Time is spent acquiring [knowledge]({{ 'knowledge/' | relative_url }}) that may never be used.
...
<img src="{{ "/assets/images/increasing_re_852ca6_purpose_based_25e5d2_technical_doc_adaa0a_reference_doc_c0a3fd-Illustration-3-dark.svg" | relative_url }}" alt="Reference Lookup illustration 3" data-theme-src-dark="{{ "/assets/images/increasing_re_852ca6_purpose_based_25e5d2_technical_doc_adaa0a_reference_doc_c0a3fd-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/increasing_re_852ca6_purpose_based_25e5d2_technical_doc_adaa0a_reference_doc_c0a3fd-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
...
<section class="further-reading-section" data-page-toc-exclude aria-labelledby="further-reading-title">
  <div class="fr-section-shell">
    ...
    <div class="fr-section-footer">
      <div class="fr-browse-links" aria-label="Browse more on Amazon"><span class="fr-browse-links-label">Browse more on Amazon:</span> <a class="fr-browse-more" href="https://www.amazon.com/s?k=The+Linux+Command+Line&amp;i=stripbooks&amp;tag=searcht-20" target="_blank" rel="sponsored noopener noreferrer">The Linux Command Line</a> <a class="fr-browse-more" href="https://www.amazon.com/s?k=UNIX+and+Linux+System+Administration+%285th+Edition%29+books&amp;i=stripbooks&amp;tag=searcht-20" target="_blank" rel="sponsored noopener noreferrer">UNIX and Linux System Administration (5th Edition) books</a> <a class="fr-browse-more" href="https://www.amazon.com/s?k=Site+Reliability+Engineering&amp;i=stripbooks&amp;tag=searcht-20" target="_blank" rel="sponsored noopener noreferrer">Site Reliability Engineering</a></div>
