...
- increasing_re_852ca6_measure_readi_fdb760_retell_test_l_1b3f2a_index
...
show_ads: true
description: Retelling can reveal meaning, sequence, and detail, but it should not be treated as the only proof of comprehension.
hero_summary: Retelling can reveal meaning, sequence, and detail, but it should not be treated as the only proof of comprehension.
layout: default
permalink: /retell-limits/
sidebar_expanded_urls:
- /increasing/
- /measure/
nav_short_title: Retell Limits
title: When retelling helps and when it misleads
title_full: When retelling helps and when it misleads
display_title_short: Retell Limits
display_title: Retell Limits
heading_title: When retelling helps and when it misleads
page_heading_title: When retelling helps and when it misleads
source_count: 27
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: Why one reading speed number is misleading
header:
  og_image: /assets/images/increasing_re_852ca6_measure_readi_fdb760_retell_test_l_1b3f2a-Illustration-1-social.jpg
  preview_image: /assets/images/increasing_re_852ca6_measure_readi_fdb760_retell_test_l_1b3f2a-Illustration-1.webp
image: /assets/images/increasing_re_852ca6_measure_readi_fdb760_retell_test_l_1b3f2a-Illustration-1-social.jpg
---

## Introduction

Retelling is one of the most intuitive ways to check whether faster reading still produces understanding. After a timed reading, the reader explains the text in their own words, ideally capturing the main idea, key points, and sequence of information. Because retelling requires more than recognising words or recalling isolated facts, it is often used as a comprehension [measure]({{ 'measure/' | relative_url }}) in schools, literacy research, and reading assessments.
...
One reason retelling matters in reading-speed [practice]({{ 'practice/' | relative_url }}) is that speed gains can create an illusion of competence.
...
* supporting evidence;
* qualifications and [exceptions]({{ 'exceptions/' | relative_url }});
* implied meanings;
* author intent.
...
2. **Identify the main point** in [one sentence]({{ 'one-sentence/' | relative_url }}).

<div class="content-enhancement content-enhancement--step-flow" markdown="1">

3. **Answer a detail question** about a specific fact or example.
4. **Answer an inference question** that requires reasoning beyond explicit statements.
5. **Explain the author's purpose or conclusion.**
