...
show_ads: true
description: RSVP can feel fast, but higher word rates often trade visible progress for weaker retention and inference.
hero_summary: RSVP can feel fast, but higher word rates often trade visible progress for weaker retention and inference.
layout: default
...
- /reading-apps/
- /fixed-pacing/
nav_short_title: Speed Tradeoff
title: When Faster Words Mean Less Understanding
title_full: When Faster Words Mean Less Understanding
display_title_short: Speed Tradeoff
display_title: Speed Tradeoff
heading_title: When Faster Words Mean Less Understanding
page_heading_title: When Faster Words Mean Less Understanding
source_count: 53
infographic_count: 3
planned_sections:
- Why speed feels convincing
- Where comprehension starts to fall
- How to test speed without fooling yourself
...
image: /assets/images/increasing_re_852ca6_rsvp_reading_26badc_fixed_timing_110cf1_rsvp_speed_tr_fbaed8-Illustration-1-social.jpg
---
...
* Remembering specific facts and details.
* Connecting information across sentences.
* Drawing inferences that are not explicitly stated.
* Building a coherent mental model of the text.
...
## Why Inference Breaks Before Word Recognition

The most revealing finding in RSVP research is that understanding often fails not because readers cannot recognise words quickly enough, but because they cannot integrate them into larger structures quickly enough.
...
* Tracking multiple characters or concepts.
* Following long sentences with embedded clauses.
* Understanding technical explanations.
* Detecting qualifications, exceptions, or contradictions.
* Making connections between distant parts of a passage.
...
## The Hidden Cost of Losing Rereading
...
* Technical manuals.
* Dense nonfiction.
* Literary texts with nuanced language.
...
The easiest way to overestimate reading ability is to measure only words per minute. A more meaningful test evaluates what remains after reading.

After a reading session, try answering questions such as:

1. Can you summarise the main argument without looking back?
2. Can you explain why events or ideas were connected?
3. Can you recall important details, not just the general theme?
4. Can you identify assumptions, [exceptions]({{ 'exceptions/' | relative_url }}), or counterarguments?
5. Could you teach the material to someone else?
...
## The Real Measure of Reading Speed
